...
},
{
  ...
  "body": " Vector space structure of   Let and be positive integers.   The set , together with the matrix addition and scalar multiplication, is a vector space.    The zero vector of is the zero matrix .    Given a matrix its vector inverse is .       Having identified the relevant operations, as well as the proposed zero vector and vector inverses, we must verify that the vector axioms hold. We do so for Axioms i, iii, and iv, leaving the rest as an exercise.   Axiom i      Axiom iii      Axiom iv      "
},
{
  "id": "rm_matrix_diff",
  "level": "2",
...
},
{
  ...
  "body": " Video example: proving matrix equalities   Video: matrix multiplication is associative  Video: matrix multiplication is associative    "
},
{
...
},
{
  ...
  "number": "3.2.13",
  "title": "Video example: proving matrix equalities.",
  "body": " Video example: proving matrix equalities   Video: transpose property  Video: transpose property    "
},
{
