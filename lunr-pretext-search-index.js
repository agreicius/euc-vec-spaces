...
},
{
  ...
  "number": "1.1.4",
  "title": "Vector space.",
  "body": " Vector space  vector space definition  vector space zero vector  vector space vector inverse  vector space vector   A real vector space is a set together with two operations , called respectively vector addition and scalar multiplication , that satify the following vector space axioms .   Vector addition is commutative   for all .    Vector addition is associative   for all .    Additive identity  There is an element such that for all , we have . We call the zero vector of .    Additive inverses  For all , there is another element satisfying . We call is called the vector inverse of .    Distribution over vector addition   for all and .    Distribution over scalar addition   for all and .    Scalar multiplication is associative   for all and all .    Scalar multiplication identity   for all .   We call elements of a vector space vectors and the elements of  scalars .   "
},
{
...
{
  "id": "ss_linear_equations-15",
  "level": "2",
  "url": "s_systems.html#ss_linear_equations-15",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
